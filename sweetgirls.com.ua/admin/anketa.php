...
<html lang="ru">
<head>
    <title>Агентство "Sweet Girls" - Анкета
    </title>
                ...
                <div class="col-md-12 animate-box">
                    <table border="1">
                        <tr>
                            ...
                            <th>Дата рождения</th>
                            <th>Гражданство</th>
                            <th>Цель знакомства</th>
                            <th>Действия</th>
                        </tr>
                        <?php
                        require_once('param.php');

                        $query = "Select id, name,surname,patname,birthday,citizenship,purpose1,purpose2,purpose3 From mail";
                        $rez = mysqli_query($dbs, $query) or die ("Error");


                        while ($anketa = mysqli_fetch_array($rez)) {


                            echo "<tr>
<td>" . $anketa['name'] . "</td>
<td>" . $anketa['surname'] . "</td>
<td>" . $anketa['patname'] . "</td>
<td>" . $anketa['birthday'] . "</td>
<td>" . $anketa['citizenship'] . "</td>
<td>" . $anketa['purpose1'] . "<br>" . $anketa['purpose2'] . "<br>" . $anketa['purpose3'] . "</td>
<td ><a href='anketa_id.php?id=" . $anketa['id'] . "'><button>Дополнительная информация</button></a> <a href='anketa_update.php?id=" . $anketa['id'] . "'><button>Редактировать</button></a> <a href='anketa_del.php?id=" . $anketa['id'] . "&name=" . $anketa['name'] . "'><button>Удалить</button></a></td>
