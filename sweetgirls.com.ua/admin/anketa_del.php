            ...
            <div class="row">
                <div class="col-md-12 animate-box">
                    ...
                    if (!isset($_POST['send'])) {
                        ...
                        ?>
                        <label>Вы действительно хотите удвлить анкету</label>
                        <form action="anketa_del.php" method="post">
                            <input name="del" value="yes" type="radio">Да
                            <input name="del" value="no" type="radio">Нет
                            <input name="id" value="<?=$del['id']?>" type="hidden">
                            <input name="send" value="Удалить" type="submit">
                        </form>
                        <?php
                    }
                    ...
                    ?>
                    <div class="col-md-12 animate-box">
                        <h3>Удаление отменено или не возможно</h3>
                    </div>
                    <?php
                    }
                    ?>
